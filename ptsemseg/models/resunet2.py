...
class resunet2(nn.Module):
    def __init__(
        ...
        self.center = unetConv2(filters[2], filters[3], self.is_batchnorm)  #channel 128-256

        # upsampling
        self.up_concat4 = unetUp(filters[3], filters[2], self.is_deconv)   #channel 256-128,problem
        self.up_concat3 = unetUp(filters[2], filters[1], self.is_deconv)    #channel 128-64
        self.up_concat2 = unetUp(filters[1], filters[0], self.is_deconv)   #channel 64-32
    ...
    def forward(self, inputs):
        ...
        center = self.center(conv3)          #now channel is 256
        ...
        up4 = self.up_concat4(conv3, center)     #center 256-128 channels, concat with 128channels conv4
